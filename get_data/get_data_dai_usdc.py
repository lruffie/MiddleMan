...
# get_rate(tokens["DAI"],tokens["USDC"],1000,network)
...
def  main(tokens, network):
    while True:
        time.sleep(10)
        list=get_rate(tokens["DAI"],tokens["USDC"],1000,network)
        manage_file('C:/Users/Ruffie Luc/PERSO/dev/CrossChainArbitrageBot-master/get_data/data/data_dai_usdc.csv',list)
